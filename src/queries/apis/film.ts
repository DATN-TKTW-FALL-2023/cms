...
export const updateFilmById = (id: string, data: any) => request({ url: `detail-film/${id}`, method: 'PATCH', data })
export const getFilmById = (id: string) => request({ url: `detail-film/${id}`, method: 'GET' })
